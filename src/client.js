...
var SuapClient = function (authHost, clientID, redirectURI, scope) {
    ...
    this.getLoginURL = function () {
        var loginUrl =
            authorizationURL + '?response_type=' + responseType + '&grant_type=' + grantType + '&client_id=' + clientID + '&scope=' + scope;
    ...
    this.getRegistrationURL = function () {
        var registrationUrl = authHost + '/register/' + '?redirect_uri=' + redirectURI;
    ...
    this.getResource = function (scope, callback) {
        ...
        axios.get(resourceURL, requestOptions).then((response) => callback(response));
    };
    ...
    this.logout = function () {
        const requestOptions = {
            method: 'post',
            params: { token: token.getValue(), client_id: clientID }
        };
        axios.get(logoutURL, requestOptions).then(token.revoke());
    };
};
